...
def generate_user_random_seed():
    seed_1 = r'assets\bigSmileBoy.png'
    seed_2 = r'assets\bigSmileGirl.png'
...
def main():
    ...
    for message in st.session_state.ask_messages:
        avatar = seed if message["role"] == "user" else r'assets\bottts.png'
    ...
    if (prompt := st.chat_input("Ask a question")):
        ...
        with st.chat_message("assistant", avatar=r'assets\bottts.png'):
